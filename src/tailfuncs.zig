...
inline fn cont(cpu: *Cpu, pc: [*]Inst, comptime inc_by_2: bool) void {
    ...
    const next = new_pc[0];
    @call(.always_tail, next.func, .{ cpu, next.decoded.toInt(), new_pc });
}

/// 00E0: clear the screen
pub fn clear(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
...
/// 00EE: return
pub fn ret(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = Decoded.fromInt(decoded).none;
...
/// 1NNN: jump to NNN
pub fn jump(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    const new_pc = &cpu.code[Decoded.fromInt(decoded).nnn];
    cont(cpu, @ptrCast(new_pc), false);
}

/// 2NNN: call address NNN
pub fn call(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
...
pub fn skipIfEqual(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
...
pub fn skipIfNotEqual(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const nn = Decoded.fromInt(decoded).xnn;
...
pub fn skipIfRegistersEqual(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
/// 6XNN: set VX to NN
pub fn setRegister(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const nn = Decoded.fromInt(decoded).xnn;
    cpu.v[x] = nn;
    cont(cpu, pc, true);
}
...
pub fn addImmediate(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const nn = Decoded.fromInt(decoded).xnn;
    cpu.v[x] +%= nn;
    cont(cpu, pc, true);
}
...
/// 8XY0: set VX to VY
pub fn setRegisterToRegister(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
...
pub fn bitwiseOr(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn bitwiseAnd(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const y = Decoded.fromInt(decoded).xy;
    cpu.v[x] &= cpu.v[y];
    cont(cpu, pc, true);
}
...
pub fn bitwiseXor(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn addRegisters(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const y = Decoded.fromInt(decoded).xy;
...
pub fn subRegisters(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const y = Decoded.fromInt(decoded).xy;
...
pub fn shiftRight(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn subRegistersReverse(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const y = Decoded.fromInt(decoded).xy;
...
pub fn shiftLeft(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const y = Decoded.fromInt(decoded).xy;
...
pub fn skipIfRegistersNotEqual(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
/// ANNN: set I to NNN
pub fn setI(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    cpu.i = Decoded.fromInt(decoded).nnn;
    cont(cpu, pc, true);
}

/// BNNN: jump to NNN + V0
pub fn jumpV0(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn random(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, const nn = Decoded.fromInt(decoded).xnn;
...
pub fn draw(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
...
pub fn skipIfPressed(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn skipIfNotPressed(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn readDt(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
...
pub fn waitForKey(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn setDt(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, _ = Decoded.fromInt(decoded).xnn;
    cpu.dt = cpu.v[x];
    cont(cpu, pc, true);
}
...
pub fn setSt(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn incrementI(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, _ = Decoded.fromInt(decoded).xnn;
    cpu.i +%= cpu.v[x];
    cont(cpu, pc, true);
}
...
pub fn setIToFont(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, _ = Decoded.fromInt(decoded).xnn;
...
pub fn storeBcd(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x, _ = Decoded.fromInt(decoded).xnn;
...
pub fn store(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
...
pub fn load(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    const x: u8, _ = Decoded.fromInt(decoded).xnn;
...
pub fn storeFlags(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
...
pub fn loadFlags(cpu: *Cpu, decoded: Decoded.Int, pc: [*]Inst) void {
    _ = pc;
    _ = decoded;
